<template>
    ...
    <div class="password-login" v-show="toggleFlag">
      <yx-field @focus="onfocus" @blur="onblur" v-model.trim="username" label="账号" label-icon="user" placeholder="请输入登录账号" @click-clear="username = ''"></yx-field>
...
<script>
import YxField from '@/components/common/components/yx-field'
