  ...
  <div class="layout">
    <div class="header">
      ...
      <div class="nav" style="position:fixed;top: 10px;">        
        ...
        <mu-flat-button :label="chooseTestBtn" class="tab demo-flat-button" icon="color_lens" @click="formatDataUrl()"  primary backgroundColor="#FFFFFF" :color="color.hex"/>
        <mu-flat-button label="灰度" class="tab demo-flat-button" icon="color_lens" @click="setGrey()"  primary backgroundColor="#FFFFFF" :color="color.hex"/>
        <mu-flat-button label="扩散" class="tab demo-flat-button" icon="color_lens" @click="setSpread()"  primary backgroundColor="#FFFFFF" :color="color.hex"/>
...
import mixins1 from "./mixins/mixin1.js";
import mixins2 from "./mixins/mixin2.js";
import extend from "./extends/extend1.js";
...
export default {
  ...
  methods: {
    ...
    setGrey() {
      ...
      this.context.putImageData(this.black(imageData), 0, 0);
    },
    setSpread() {
      let imageData = this.context.getImageData(
        0,
      ...
      this.context.putImageData(this.spread(imageData), 0, 0);
    },
    ...
    old(canvasData) {
      for (var x = 0; x < canvasData.width; x++) {
        for (var y = 0; y < canvasData.height; y++) {
          ...
          var dr = 0.393 * r + 0.769 * g + 0.189 * b;
          var dg = 0.349 * r + 0.686 * g + 0.168 * b;
          var db = 0.272 * r + 0.534 * g + 0.131 * b;
    ...
    downloadImage() {
      ...
      console.log(55555, this.canvas.toDataURL());
