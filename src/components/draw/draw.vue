  ...
  <div class="layout">
    <div class="header">
      ...
      <div class="logo">
        ...
        <div class="nav" style="top: 10px;">        
        <mu-flat-button label="灰度" class="tab demo-flat-button" icon="color_lens" @click="setGrey()"  primary backgroundColor="#FFFFFF" />
        <mu-flat-button label="扩散" class="tab demo-flat-button" icon="color_lens" @click="setSpread()"  primary backgroundColor="#FFFFFF" />       
      </div>
